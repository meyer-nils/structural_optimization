...
\begin{align}
    ...
    \frac{\partial \mathcal{\mathcal{L}}}{\partial \lambda_j} (\mathbf{x}^*, \pmb{\mu}^*, \pmb{\lambda}^*) = h_j(\mathbf{x}^*) &= 0 \quad j \in [1,m]\\
    \frac{\partial \mathcal{\mathcal{L}}}{\partial \mu_i} (\mathbf{x}^*, \pmb{\mu}^*, \pmb{\lambda}^*) = g_i(\mathbf{x}^*) &\le 0 \quad i \in [1,n]\\
...
\end{equation}
does not provide much improvement, because the inner term $\bar{\mathcal{\mathcal{L}}}(\mathbf{x})$ just states the constraints 
\begin{align}
