...
\begin{example}{CONLIN}{conlinexample}
    ...
    \begin{center}
        \includegraphics[width=0.8\textwidth]{figures/four_bar_truss.png}
    \end{center}
...
\begin{example}{MMA}{mmaexample}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \textrm{s.t.} \quad     & g(\mathbf{x}) = \frac{8}{16x_1+9x_2} - \frac{4.5}{9x_1+16x_2} -0.1 \le 0  \\
            \quad     & \mathbf{x} \in [0.2,2.5]^2
        \end{aligned}
    \end{equation}

    A MMA approximation at $\mathbf{x}^0=(2,1)^\top$ is illustrated in the following image with the dashed line for $s_0=0.2$. 
    \begin{center}
